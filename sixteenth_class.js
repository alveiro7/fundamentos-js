...
function horoscopoJavaScript()
{
    switch (signo) {
        case 'acuario':
          document.write(`${signo.toUpperCase()} Intente aislarse del mundo y sentarse en soledad a reflexionar sobre ciertas cuestiones de su vida que últimamente no lo dejan progresar de la manera que anhela.`)
          break
    
        case 'piscis':
          document.write(`${signo.toUpperCase()} Sepa que de ahora en más, su futuro solo dependerá de usted solo. Entienda que ya está capacitado para tomar sus propias decisiones y realizar los planes deseados.`)
          break
    
        case 'cáncer':
        case 'cancer':
          console.log(`${signo.toUpperCase()}Dentro su cabeza le surgirán ideas extraordinarias, sobre todo si se dedica a actividades creativas donde pueda ponerlas en práctica.`)
          break
        case 'aries':
